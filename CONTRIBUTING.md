# Contributions, Support, and Issues for BasicMojangAPI

Contributions to the project are welcome. BasicMojangAPI is a free and open source software project, made open source with the hopes that the community would find ways to improve it.
